...
const SYSTEM = `You are Longhorn Intelligence, the ultimate AI for Texas Longhorns football on tower-report.vercel.app.
...
export default async function handler(req) {
  ...
  try {
    ...
    const result = streamText({ model: xai('grok-4'), messages, system: SYSTEM });
